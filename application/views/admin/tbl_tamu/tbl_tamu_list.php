<div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('admin/tbl_tamu/create'), 'Create', 'class="btn btn-primary"'); ?>
            </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?php echo base_url() ?>admin/tbl_tamu/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_tamu",
                            "orderable": false
                        },{"data": "nama_tamu"},{"data": "daftar_tamu"},
                        {
                            "data" : "action",
                            "orderable": false,
