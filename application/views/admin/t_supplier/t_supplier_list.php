<div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('admin/t_supplier/create'), 'Create', 'class="btn btn-primary"'); ?>
            </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?php echo base_url() ?>admin/t_supplier/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_supplier",
                            "orderable": false
                        },{"data": "nama_sup"},{"data": "tlp_sup"},{"data": "email_sup"},{"data": "alamat_sup"},
                        {
                            "data" : "action",
                            "orderable": false,
