<div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('admin/tbl_rekap/create'), 'Create', 'class="btn btn-primary"'); ?>
            </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?php echo base_url() ?>admin/tbl_rekap/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_rekap",
                            "orderable": false
                        },{"data": "tanggal"},{"data": "nospt"},{"data": "mak"},{"data": "nama_hotel"},{"data": "total_tagihan"},{"data": "first_name"},
                        {
                            "data" : "action",
                            "orderable": false,
