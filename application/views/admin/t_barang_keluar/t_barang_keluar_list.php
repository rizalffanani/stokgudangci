<div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('admin/t_barang_keluar/create'), 'Create', 'class="btn btn-primary"'); ?>
            </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?php echo base_url() ?>admin/t_barang_keluar/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_bk",
                            "orderable": false
                        },{"data": "tgl_bk"},{"data": "nama_barang"},{"data": "jml_bk"},
                        {
                            "data": "harga_bk",
