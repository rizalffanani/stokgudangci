<div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('admin/tbl_hotel/create'), 'Create', 'class="btn btn-primary"'); ?>
            </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?php echo base_url() ?>admin/tbl_hotel/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_hotel",
                            "orderable": false
                        },{"data": "nama_hotel"},{"data": "kota"},{"data": "alamat"},{"data": "telepon"},{"data": "id_prov"},{"data": "confirm"},{"data": "group"},
                        {
                            "data" : "action",
                            "orderable": false,
